...
PATTERN="3 2 5 8 7" # The unlock pattern to draw, space seperated
...
MULTIPLIER=2.1                # Multiplication factor for coordinates. For Nexus 4, set this to 2. For low res phones such as
